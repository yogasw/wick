...
func (s *errStore) ListEventsTail(id, runID string, limit int) ([]workflow.RunEvent, int, error) {
	return nil, 0, nil
}
...
func (s *okStore) ListEventsTail(id, runID string, limit int) ([]workflow.RunEvent, int, error) {
	return nil, 0, nil
}
