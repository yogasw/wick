...
// freshly-loaded DRAFT without first publishing it — Router.defs
// only ever holds the published copy so triggers (cron, channel,
// webhook) keep firing the live version while the user iterates on
// the draft.
