...
// can't grow it without bound. Snapshot returns the current contents for
// a fresh subscriber's initial paint; every Write also fans the new chunk
// out to live SSE subscribers so the log panel tails in real time.
