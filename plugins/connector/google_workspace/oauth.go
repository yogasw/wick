// google_workspace plugin, oauth.go: OAuthMeta implementation for the Google Workspace connector.
//
...
//
// Caller:   OAuthMeta() referenced from connector.go::Module()
...
func OAuthMeta() *connector.OAuthMeta {
	return &connector.OAuthMeta{
		...
		Scopes: strings.Join([]string{
			...
			// Meet: create spaces + read conference data (records, recordings, transcripts).
			// meetings.space.created is a superset of meetings.space.readonly.
