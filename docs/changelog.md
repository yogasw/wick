...
- Updated CI workflow to remove root CHANGELOG.md and sync documentation files directly during the release process.
- Configured CI to use administrative tokens for automated pull request creation, approval, and merging.
- Added automatic version comparison links to changelog documentation entries.
